...
export const GroupIcon: React.FC<IIconProps> = ({ size = 30 }) => {
    return (
        <SvgIcon
            width={size}
            height={size}
            ...
            `}
        >
            <circle cx="15" cy="6.875" r="3.625" stroke="#2F97FF" strokeWidth="1.5" />
            <circle cx="6.875" cy="23.125" r="3.625" stroke="#2F97FF" strokeWidth="1.5" />
            <circle cx="23.125" cy="23.125" r="3.625" stroke="#2F97FF" strokeWidth="1.5" />
            <path
