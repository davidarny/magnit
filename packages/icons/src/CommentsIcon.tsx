...
export const CommentsIcon: React.FC<IIconProps> = ({ size = 30, ...props }) => {
    return (
        <SvgIcon
            width={size}
            height={size}
        ...
        >
            <path
                ...
                fill="currentColor"
            />
            <circle cx="10" cy="13.125" r="1.25" fill="currentColor" />
            <circle cx="15" cy="13.125" r="1.25" fill="currentColor" />
            <circle cx="20" cy="13.125" r="1.25" fill="currentColor" />
        </SvgIcon>
    );
};
